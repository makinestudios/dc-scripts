...
/////////////////////////////////////////////////////////////////////////
//                                                                          
// MAkinE - Disney MON BUMP Toolkit
//
// ©2017 Jorge Vasquez
...
var tcd_scriptName = "MAkinE - DC MON BUMP Toolkit ";
var tcd_version = "0.8";
//
...
function tcd_buildUI(thisObj) {
    ...
    if ( getComp("DC_MON_BUMP_##Base##_5s") == null )
    {
        alert("Make sure to have the DC_MON_BUMP Template project open before running the script");
        return;
    }
    ...
    if (myPal != null) {
        ...
        myPal.comp = getComp("DC_MON_BUMP_##Base##_5s");
...
function setBG ( id ){
    new_source = myPalette.comp.layer("DC_MON_BG_"+String(id)).source;
    a = myPalette.comp.layer("BG");
    a.replaceSource(new_source,false)
}
var paletteOptions = ["C","D","E","F","G","H","I","J"];       
...
var colors = {
    ...
    purple_dark_hawlloween : 0x401D6C,
    orange : 0xff8400,
    green_dark : 0x1D662C,
    green_light: 0x93a1c,
    black: 0x000000,
...
var palettes = {
    ...
    I : {
        col_title:          colors.purple,
        col_bubble:         colors.black,
        col_bubble_shadow:  colors.yellow,
        col_logo_bg :       colors.yellow,
        col_logo_fg:        colors.black,
        col_logo_neutral:   colors.cyan,
        col_logo_accent:    colors.gray_50
        },
    J : {
        col_title:          colors.orange,
        col_bubble:         colors.black,
        col_bubble_shadow:  colors.yellow,
        col_logo_bg :       colors.purple,
        col_logo_fg:        colors.yellow,
        col_logo_neutral:   colors.gray_dark,
        col_logo_accent:    colors.black
        }
}
